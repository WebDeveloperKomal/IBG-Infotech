...
function teamData() {
    fetch('http://localhost:8181/ibg-infotech/auth/get-all-members', {
        ...
        .then(data => {
            ...
            const fourthRecord = data1[3];
            const fifthRecord = data1[4];
            const sixthRecord = data1[5];
            const seventhRecord = data1[6];
            const eightRecord = data1[7];
            const ninethRecord = data1[8];
            const tenthRecord = data1[9];
            const elevenRecord = data1[10];
